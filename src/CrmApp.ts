...
export interface ICrmApp {
   ...
   * 人员自定义产品接口
   */
  readonly personProductApi: PersonProductApi;
   ...
   * 库存接口
   */
  readonly stockApi: StockApi;

  /**
   * Stock site API
   * 库存点接口
   */
  readonly stockSiteApi: StockSiteApi;
...
export class CrmApp implements ICrmApp {
  ...
  private _personProductApi?: PersonProductApi;
  /**
   * Person product API
   * 人员自定义产品接口
   */
  get personProductApi() {
    return (this._personProductApi ??= new PersonProductApi(this.app));
  }
   ...
   */
  get stockApi() {
    return (this._stockApi ??= new StockApi(this.app));
  }

  private _stockSiteApi?: StockSiteApi;
  /**
   * Stock site API
   * 库存点接口
   */
  get stockSiteApi() {
    return (this._stockSiteApi ??= new StockSiteApi(this.app));
  }
   ...
   * @returns Result
   */
  hasView(identity: IdentityTypeFlags) {
    return this.ownsIdentity(identity, "View");
  }
